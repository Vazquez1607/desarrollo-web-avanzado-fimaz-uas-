...
class ProductoController
{
    ...
    public function store(): void
    {
        ...
        if ((float)$data["precio_compra"] < 0 || (float)$data["precio_venta"] < 0 || (int)$data["existencia"] < 1) {
            $_SESSION["error"] = "La existencia debe ser mayor a 0.";
            header("Location: index.php?route=productos/create");
            exit;
        }
    ...
    public function update(): void
    {
        ...
        if ((float)$data["precio_compra"] < 0 || (float)$data["precio_venta"] < 0 || (int)$data["existencia"] < 1) {
            $_SESSION["error"] = "Siempre debe de aver mas de 0 productos.";
            header("Location: index.php?route=productos/edit&id=$id");
            exit;
        }
